...
export function DocumentPreview({ url, fileType }: DocumentPreviewProps) {
    ...
    if (isImage) {
        return (
            <div className="w-full h-[600px] bg-muted rounded-lg border flex items-center justify-center overflow-hidden">
    ...
    return (
        <div className="w-full h-[600px] bg-muted/50 rounded-lg border flex flex-col items-center justify-center text-muted-foreground">
